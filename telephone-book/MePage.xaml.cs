...
namespace telephone_book
{
    ...
    public partial class MePage : Page
    {
        ...
        private void update_button(object sender, EventArgs e)
        {
            ...
            users newUser = new users { id = user.id, login = username_text_box.Text, number = number_text_box.Text, role_id = roles[role_combo_box.Text], password = password_text_box.Text };
